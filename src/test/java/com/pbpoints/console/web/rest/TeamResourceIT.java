...
import com.pbpoints.console.repository.TeamRepository;
import com.pbpoints.console.service.criteria.TeamCriteria;
import com.pbpoints.console.service.dto.TeamDTO;
import com.pbpoints.console.service.mapper.TeamMapper;
...
class TeamResourceIT {
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().name(DEFAULT_NAME).logo(DEFAULT_LOGO).logoContentType(DEFAULT_LOGO_CONTENT_TYPE);
        return team;
    }
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().name(UPDATED_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
        return team;
    }
    ...
    void putNewTeam() throws Exception {
        ...
        updatedTeam.name(UPDATED_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.name(UPDATED_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
