...
/**
 * Criteria class for the {@link com.pbpoints.console.domain.Event} entity. This class is used
 * in {@link com.pbpoints.console.web.rest.EventResource} to receive all the possible filtering options from
...
public class EventCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, status, tournamentId);
    }
