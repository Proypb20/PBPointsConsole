...
import com.pbpoints.console.service.TournamentQueryService;
import com.pbpoints.console.service.TournamentService;
...
/**
 * REST controller for managing {@link com.pbpoints.console.domain.Tournament}.
 */
@RestController
@RequestMapping("/api")
public class TournamentResource {
    ...
    public ResponseEntity<List<TournamentDTO>> getAllTournaments(TournamentCriteria criteria) {
        log.debug("REST request to get Tournaments by criteria: {}", criteria);
        List<TournamentDTO> entityList = tournamentQueryService.findByCriteria(criteria);
