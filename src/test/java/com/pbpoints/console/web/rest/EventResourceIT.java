...
class EventResourceIT {
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().name(DEFAULT_NAME).status(DEFAULT_STATUS);
        // Add required entity
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().name(UPDATED_NAME).status(UPDATED_STATUS);
        // Add required entity
        Tournament tournament;
        if (TestUtil.findAll(em, Tournament.class).isEmpty()) {
    ...
    void putNewEvent() throws Exception {
        ...
        updatedEvent.name(UPDATED_NAME).status(UPDATED_STATUS);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.name(UPDATED_NAME).status(UPDATED_STATUS);
