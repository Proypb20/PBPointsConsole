...
import { GamePlayComponent } from './gameplay/game-play.component';
...
@NgModule({
  ...
  declarations: [GameComponent, GameDetailComponent, GameUpdateComponent, GamePlayComponent, GameDeleteDialogComponent],
