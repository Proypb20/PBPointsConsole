...
import com.pbpoints.console.service.EventQueryService;
import com.pbpoints.console.service.EventService;
...
/**
 * REST controller for managing {@link com.pbpoints.console.domain.Event}.
 */
@RestController
@RequestMapping("/api")
public class EventResource {
     ...
     */
    @GetMapping("/events")
    public ResponseEntity<List<EventDTO>> getAllEvents(EventCriteria criteria) {
        log.debug("REST request to get Events by criteria: {}", criteria);
        List<EventDTO> entityList = eventQueryService.findByCriteria(criteria);
